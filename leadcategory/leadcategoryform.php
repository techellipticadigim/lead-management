...
<body>  
    <div class="container">
        ...
        <form method="POST">
            ...
            <label class="labeltxt">CATADDTIMESTAMP</label>
			<input type="datetime-local" class="textbox" style="font-size:18px;height:30px;font-weight:500;letter-spacing:0.5px;" 
			name="start_timestamp" id="start_timestamp" value=""/>
            <br>
    ...
    function submitForm(){
       ...
       var params= "n1="+category_name+"&n2="+category_description+"&n3="+start_timestamp;
